...
pocolog viso2_evaluation_imu.0.log -s /viso2_evaluation_imu.odometry_heading >> with_imu/odom_head    ing.txt  
pocolog viso2_evaluation_imu.0.log -s /viso2_evaluation_imu.odometry_pitch >> with_imu/odom_pitch.    txt  
pocolog viso2_evaluation_imu.0.log -s /viso2_evaluation_imu.odometry_roll >> with_imu/odom_roll.tx    t  
